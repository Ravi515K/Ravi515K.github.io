    ...
    <>
      ...
      <ContactWrapper id="about">
        <div className="Container">
          <div className="SectionTitle" style={{ "margin-top": "50px" }}>About Me</div>
          <div className="BigCard">
            ...
            <div className="AboutBio">
              {/* <ul> */}
              <li
              >Hello! My name is <strong>Ravichandra Koli </strong>and I enjoy creating things that live on the internet.
              </li>
              <li>
